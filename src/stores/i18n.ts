...
const messages: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'settings.heroVideo': '首页视频',
    'settings.heroVideoHint': '填入视频链接（MP4），将在首页自动播放',
    'settings.save': '保存设置',
    'settings.saved': '设置已保存',
    'settings.preview': '资料卡预览',
    'home.videoHint': '设置中添加视频',
    // Profile
    'profile.posts': '文章',
    'profile.nfts': 'NFT',
    'profile.readers': '读者',
  ...
  'zh-TW': {
    ...
    'settings.heroVideo': '首頁影片',
    'settings.heroVideoHint': '填入影片連結（MP4），將在首頁自動播放',
    'settings.save': '儲存設定',
    'settings.saved': '設定已儲存',
    'settings.preview': '資料卡預覽',
    'home.videoHint': '在設定中新增影片',
    'profile.posts': '文章',
    'profile.nfts': 'NFT',
    'profile.readers': '讀者',
  },
  'en-US': {
    ...
    'topbar.search': 'Search posts, capsules, knowledge...',
    ...
    'settings.heroVideo': 'Hero Video',
    'settings.heroVideoHint': 'Enter a video URL (MP4) to auto-play on homepage',
    'settings.save': 'Save Settings',
    'settings.saved': 'Settings saved',
    'settings.preview': 'Profile Preview',
    'home.videoHint': 'Add video in Settings',
    'profile.posts': 'Posts',
    'profile.nfts': 'NFTs',
  ...
  'ja-JP': {
    ...
    'settings.heroVideo': 'トップ動画',
    'settings.heroVideoHint': '動画リンク（MP4）を入力、トップで自動再生',
    'settings.save': '設定を保存',
    'settings.saved': '保存しました',
    'settings.preview': 'プレビュー',
    'home.videoHint': '設定で動画を追加',
    'profile.posts': '投稿',
    'profile.nfts': 'NFT',
    'profile.readers': '読者',
  },
  'ko-KR': {
    ...
    'nav.home': '홈', 'nav.album': '앨범', 'nav.starsealed': '星封',
    ...
    'topbar.back': '뒤로', 'topbar.lang': '언어', 'topbar.theme': '테마', 'sidebar.connected': '연결됨',
    'page.home': '홈', 'page.album': '앨범', 'page.starsealed': 'Starsealed',
    ...
    'settings.social': '소셜 링크', 'settings.heroVideo': '홈 동영상',
    'settings.heroVideoHint': '동영상 링크(MP4)를 입력하면 홈에서 자동 재생',
    'settings.save': '설정 저장',
    'settings.saved': '저장 완료', 'settings.preview': '미리보기',
    'home.videoHint': '설정에서 동영상 추가',
    'profile.posts': '글', 'profile.nfts': 'NFT', 'profile.readers': '독자',
  },
  'fr-FR': {
    'nav.explore': 'Explorer', 'nav.knowledge': 'Savoir', 'nav.social': 'Social',
    'nav.home': 'Accueil', 'nav.album': 'Album', 'nav.starsealed': 'Starsealed',
    ...
    'topbar.back': 'Retour', 'topbar.lang': 'Langue', 'topbar.theme': 'Thème', 'sidebar.connected': 'Connecté',
    'page.home': 'Accueil', 'page.album': 'Album', 'page.starsealed': 'Starsealed',
    ...
    'settings.social': 'Liens sociaux', 'settings.heroVideo': 'Vidéo d\'accueil',
    'settings.heroVideoHint': 'Lien vidéo (MP4) pour lecture automatique',
    'settings.save': 'Enregistrer',
    'settings.saved': 'Enregistré', 'settings.preview': 'Aperçu',
    'home.videoHint': 'Ajouter vidéo dans Paramètres',
  ...
  'de-DE': {
    ...
    'nav.home': 'Startseite', 'nav.album': 'Album', 'nav.starsealed': 'Starsealed',
    ...
    'topbar.back': 'Zurück', 'topbar.lang': 'Sprache', 'topbar.theme': 'Design', 'sidebar.connected': 'Verbunden',
    'page.home': 'Startseite', 'page.album': 'Album', 'page.starsealed': 'Starsealed',
    ...
    'settings.social': 'Soziale Links', 'settings.heroVideo': 'Startseiten-Video',
    'settings.heroVideoHint': 'Videolink (MP4) für automatische Wiedergabe',
    'settings.save': 'Speichern',
    'settings.saved': 'Gespeichert', 'settings.preview': 'Vorschau',
    'home.videoHint': 'Video in Einstellungen hinzufügen',
    'profile.posts': 'Beiträge', 'profile.nfts': 'NFTs', 'profile.readers': 'Leser',
  },
  'es-ES': {
    'nav.explore': 'Explorar', 'nav.knowledge': 'Saber', 'nav.social': 'Social',
    'nav.home': 'Inicio', 'nav.album': 'Álbum', 'nav.starsealed': 'Starsealed',
    ...
    'topbar.back': 'Volver', 'topbar.lang': 'Idioma', 'topbar.theme': 'Estilo', 'sidebar.connected': 'Conectado',
    'page.home': 'Inicio', 'page.album': 'Álbum', 'page.starsealed': 'Starsealed',
    ...
    'settings.social': 'Enlaces sociales', 'settings.heroVideo': 'Vídeo de inicio',
    'settings.heroVideoHint': 'Enlace de vídeo (MP4) para reproducción automática',
    'settings.save': 'Guardar',
    'settings.saved': 'Guardado', 'settings.preview': 'Vista previa',
    'home.videoHint': 'Añadir vídeo en Ajustes',
  ...
  'ru-RU': {
    ...
    'nav.home': 'Главная', 'nav.album': 'Альбом', 'nav.starsealed': 'Starsealed',
    ...
    'topbar.back': 'Назад', 'topbar.lang': 'Язык', 'topbar.theme': 'Стиль', 'sidebar.connected': 'Подключено',
    'page.home': 'Главная', 'page.album': 'Альбом', 'page.starsealed': 'Starsealed',
    ...
    'settings.social': 'Соцсети', 'settings.heroVideo': 'Видео на главной',
    'settings.heroVideoHint': 'Ссылка на видео (MP4) для автовоспроизведения',
    'settings.save': 'Сохранить',
    'settings.saved': 'Сохранено', 'settings.preview': 'Предпросмотр',
    'home.videoHint': 'Добавить видео в Настройках',
