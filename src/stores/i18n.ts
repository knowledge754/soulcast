...
const messages: Record<Locale, Record<string, string>> = {
  ...
  'ko-KR': {
    ...
    'topbar.back': '뒤로', 'topbar.lang': '언어', 'topbar.theme': '테마',
  ...
  'fr-FR': {
    ...
    'topbar.back': 'Retour', 'topbar.lang': 'Langue', 'topbar.theme': 'Thème',
  ...
  'de-DE': {
    ...
    'topbar.back': 'Zurück', 'topbar.lang': 'Sprache', 'topbar.theme': 'Design',
  ...
  'es-ES': {
    ...
    'topbar.back': 'Volver', 'topbar.lang': 'Idioma', 'topbar.theme': 'Estilo',
  ...
  'ru-RU': {
    ...
    'topbar.back': 'Назад', 'topbar.lang': 'Язык', 'topbar.theme': 'Стиль',
